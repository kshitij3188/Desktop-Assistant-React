# Live Demo: [Voice Assistant: Hazel](#)

It will recognize what you say and answer accordingly.

**It can perform the following tasks :**

1) Does Google ,Youtube ,Wikipedia searches.
2) Open websites like Google,Unsplash, Spotify, in a web browser.
3) Sends mail.
4) Tells the current date and time.
5) Also tells the current weather conditions.
6) Plays music.
7) Know the current covid details.
8) Tells you a random qoute.
